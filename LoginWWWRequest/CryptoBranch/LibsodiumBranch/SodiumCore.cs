...
using static LoginWWWRequest.CryptoBranch.LibsodiumBranch.InteropBranch.Version;
using static LoginWWWRequest.CryptoBranch.LibsodiumBranch.InteropBranch.Core;

namespace LoginWWWRequest.CryptoBranch.LibsodiumBranch
{
    public class SodiumCore
    {
        ...
        private static void InitializeCore()
        {
            try
            {
                ...
                {
                    string version = null;
                    version = Marshal.PtrToStringAnsi(sodium_version_string());
